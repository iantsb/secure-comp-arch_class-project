...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[height=0.22\textheight]{strength_bal.png}
        \caption{Bit Mean Scatter Plot}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[height=0.22\textheight]{strength_hd.png}
...
\hline
\# Rows & \# Banks & Bit Mean & HD (avg) & Single-shot Time & Adjusted Time \\
\hline
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[height=0.22\textheight]{bank_HD.png}
        \caption{Hamming Distance vs #Banks}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[height=0.22\textheight]{bank_mean.png}
        \caption{Bit Mean vs #Banks}
    \end{subfigure}
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[height=0.22\textheight]{bank_time.png}
